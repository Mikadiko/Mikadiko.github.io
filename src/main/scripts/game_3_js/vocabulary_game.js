    ...
    constructor() {
        ...
        this.wordSets = {
            vocabulary_set_1: {
                ...
                instruction: "Буквы о и е после шипящих.",
                words: [
                    { word: 'свинц_вые тучи', answer: 'о' },
                    { word: 'еж_вые рукавицы', answer: 'о' },
                    { word: 'ситц_вый фартук', answer: 'е' },
                    { word: 'плюш_вый медвежонок', answer: 'е' },
                    { word: 'грош_вый выигрыш', answer: 'о' },
                    { word: 'парч_вый халат', answer: 'о' },
                    { word: 'вещ_вой мешок', answer: 'е' },
                    { word: 'камыш_вый кот', answer: 'о' },
                    { word: 'ключ_вая вода', answer: 'е' },
                    { word: 'куч_вые облака', answer: 'е' },
                    { word: 'ландыш_вый запах', answer: 'е' },
                    { word: 'холщ_вая сумка', answer: 'о' },
                    { word: 'пунц_вый закат', answer: 'о' },
                    { word: 'кварц_вые часы', answer: 'е' },
                    { word: 'плюшевый медвеж_нок', answer: 'о' },
                ]
            },
            vocabulary_set_2: {
                ...
                instruction: "Буквы о и е после шипящих.",
                words: [
                    { word: 'морж_вая охота', answer: 'о' },
                    { word: 'изразц_вая печь', answer: 'о' },
                    { word: 'крепкая беч_вка', answer: 'е' },
                    { word: 'неровный ш_в', answer: 'о' },
                    { word: 'оранж_вый карандаш', answer: 'е' },
                    { word: 'кумач_вый флаг', answer: 'о' },
                    { word: 'в свеж_м воздухе', answer: 'е' },
                    { word: 'ч_рным грачом', answer: 'е' },
                    { word: 'ветхая одеж_нка', answer: 'о' },
                    { word: 'образц_вый порядок', answer: 'о' },
                    { word: 'груш_вый сок', answer: 'е' },
                    { word: 'подж_г дома', answer: 'о' },
                    { word: 'ч_рствый хлеб', answer: 'е' },
                    { word: 'тихий ш_рох', answer: 'о' },
                    { word: 'в пахуч_м воздухе', answer: 'е' },
                    { word: 'новой страниц_й', answer: 'е' },
                    { word: 'конкурс чтец_в', answer: 'о' },
                    { word: 'древним летописц_м', answer: 'е' },
                    { word: 'прекрасным пейзаж_м', answer: 'е' },
                    { word: 'дворц_вый переворот', answer: 'о' },
                    { word: 'черным грач_м', answer: 'о' },
                ]
            },
            vocabulary_set_3: {
                ...
                words: [
                    { word: 'ж_лоб', answer: 'е' },
                    { word: 'ж_рнов', answer: 'е' },
                    { word: 'ж_лудь', answer: 'е' },
                    { word: 'ш_пот', answer: 'е' },
                    { word: 'ш_л', answer: 'е' },
                    { word: 'ш_лк', answer: 'е' },
                    { word: 'ш_рстка', answer: 'е' },
                    { word: 'ч_лка', answer: 'е' },
                    { word: 'ч_рный', answer: 'е' },
                    { word: 'кош_лка', answer: 'е' },
                    { word: 'пч_лы', answer: 'е' },
                    { word: 'ч_лн', answer: 'е' },
                    { word: 'щ_тка', answer: 'е' },
                    { word: 'ж_стко', answer: 'е' },
                    { word: 'ч_рствый', answer: 'е' },
                    { word: 'р_шетка', answer: 'е' },
                    { word: 'подж_г дома', answer: 'о' },
                    { word: 'тяж_лый', answer: 'е' },
                    { word: 'щ_лкать', answer: 'е' },
                    { word: 'щ_голь', answer: 'е' },
                    { word: 'ж_рдочка', answer: 'е' },
                    { word: 'щ_чка', answer: 'е' },
                    { word: 'ш_в', answer: 'о' },
                    { word: 'ш_рох', answer: 'о' },
                    { word: 'крыж_вник', answer: 'о' },
                    { word: 'чащ_ба', answer: 'о' },
                    { word: 'трущ_ба', answer: 'о' },
                    { word: 'ч_порный', answer: 'о' },
                    { word: 'обж_ра', answer: 'о' },
                    { word: 'ш_колад', answer: 'о' },
                    { word: 'ш_ссе', answer: 'о' },
                    { word: 'ш_фер', answer: 'о' },
                ]
            },
            vocabulary_set_4: {
                ...
                instruction: "Буквы о и е после шипящих.",
                words: [
                    { word: 'чертеж_м', answer: 'о' },
                    { word: 'туч_й', answer: 'е' },
                    { word: 'камыш_м', answer: 'о' },
                    { word: 'лапш_й', answer: 'о' },
                    { word: 'луж_й', answer: 'е' },
                    { word: 'свинц_вый', answer: 'о' },
                    { word: 'ситц_вый', answer: 'е' },
                    { word: 'плюш_вый', answer: 'е' },
                    { word: 'холщ_вый', answer: 'о' },
                    { word: 'кумач_вый', answer: 'о' },
                    { word: 'больш_й', answer: 'о' },
                    { word: 'ткач_м', answer: 'о' },
                    { word: 'реч_нка', answer: 'о' },
                    { word: 'девч_нка', answer: 'о' },
                    { word: 'руч_нка', answer: 'о' },
                    { word: 'медвеж_нок', answer: 'о' },
                    { word: 'рубаш_нка', answer: 'о' },
                    { word: 'плеч_м', answer: 'о' },
                    { word: 'летописц_м', answer: 'е' },
                    { word: 'абзац_м', answer: 'е' },
                    { word: 'о пахуч_м', answer: 'е' },
                    { word: 'чтец_в', answer: 'о' },
                    { word: 'огурц_в', answer: 'о' },
                    { word: 'отц_в', answer: 'о' },
                    { word: 'кож_й', answer: 'е' },
                    { word: 'постриж_м', answer: 'е' },
                    { word: 'завлеч_т', answer: 'е' },
                    { word: 'испеч_шь', answer: 'е' },
                    { word: 'чуж_го края', answer: 'о' },
                    { word: 'творц_м', answer: 'о' },
                    { word: 'рубеж_м', answer: 'о' },
                    { word: 'сторож_вой пост', answer: 'е' },
                    { word: 'сожж_т', answer: 'е' },
                    { word: 'грош_вый выигрыш', answer: 'о' },
                ]
            },
            vocabulary_set_5: {
                ...
                instruction: "Буквы о и е после шипящих.",
                words: [
                    { word: 'ж_сткий диван', answer: 'е' },
                    { word: 'неровный ш_в', answer: 'о' },
                    { word: 'деш_вый материал', answer: 'е' },
                    { word: 'скромная прич_ска', answer: 'е' },
                    ...
                    { word: 'камыш_вый', answer: 'о' },
                    { word: 'шапч_нка', answer: 'о' },
                    { word: 'книж_нка', answer: 'о' },
                    { word: 'мальч_нка', answer: 'о' },
                    { word: 'собач_нка', answer: 'о' },
                    { word: 'волч_нок', answer: 'о' },
                    { word: 'мыш_нок', answer: 'о' },
                    { word: 'одеж_нка', answer: 'о' },
                    { word: 'рож_к', answer: 'о' },
                    { word: 'луж_к', answer: 'о' },
                    { word: 'крюч_к', answer: 'о' },
                    { word: 'мужич_к', answer: 'о' },
                    { word: 'пирож_к', answer: 'о' },
                    { word: 'клоч_к', answer: 'о' },
                    { word: 'прыж_к', answer: 'о' },
                    { word: 'пуч_к', answer: 'о' },
                    { word: 'зеркальц_м', answer: 'е' },
                    { word: 'страниц_й', answer: 'е' },
                    { word: 'снеж_к', answer: 'о' },
                    { word: 'ландыш_м', answer: 'е' },
                    { word: 'рощ_й', answer: 'е' },
                    { word: 'свинц_м', answer: 'о' },
                    { word: 'обж_ра', answer: 'о' },
                    { word: 'расч_т', answer: 'е' },
                    { word: 'ч_рточка', answer: 'е' },
                    { word: 'ч_ткий', answer: 'е' },
                ]
            },
            vocabulary_set_6: {
