    ...
    constructor() {
        ...
        this.wordSets = {
            ...
            vocabulary_set_2: {
                ...
                instruction: "Безударные проверяемые гласные в корне слова. Вставьте правильные буквы в пропуски",
                words: [
            ...
            vocabulary_set_3: {
                ...
                instruction: "Непроверяемые безударные гласные в корне слова. Вставьте правильные буквы в пропуски",
                words: [
                    { word: 'Румя_ый', answer: 'н' },
                    { word: 'Ю_ый', answer: 'н' },
